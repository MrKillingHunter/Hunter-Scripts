...
local window = Flux:Window("Hunter Library", "Undead Defense Tycoon", Color3.fromRGB(130, 80, 176), Enum.KeyCode.End)
local Main = window:Tab("Main", "")
local Player = window:Tab("Player", "")
local CreTab = window:Tab("Credits", "")

Main:Toggle("Zombie Kill Aura", "Automatically Kills Zombies", function(autokilltoggle)
  while wait() do
...
Main:Toggle("Anti-AFK", "Prevents the Game From Kicking You For Being Idle", function()
  while wait() do
    wait(600)
...
Main:Button("Join The Smallest Server", "Joins The Server With The Least Amount Of People", function()
...
Main:Label("Auto Build Coming Soon")

Player:Slider("Walkspeed", "Makes your faster.", 0, 999,16,function(t)
  while true do
    wait (0.01)
...
Player:Bind("Fly", Enum.KeyCode.F, function()
...
Player:Bind("Noclip", Enum.KeyCode.N, function()
  while true do
  wait (0.01)
  local Noclip = nil
  local Clip = nil
...
CreTab:Label("UIs - violinsutsuki and respective creators")
CreTab:Label("Scripting - mrkillinghunter_")
